...
- If you are using the binary build from the releases section, you need to download the DLLs \(all uploaded to the [windll branch](https://github.com/PQCraft/PlatinumSrc/tree/windll)\) and do with them what is stated above.
